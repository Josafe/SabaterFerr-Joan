...
public class FinestraPrincipal extends JFrame implements ActionListener {
	...
	public FinestraPrincipal(){
		...
		setTitle("IES Benigasló - JFrame Components De Text");
	...
	private void iniciarComponentes() {
		...
		labelTitulo.setText("Components de Text - Java Swing");
		...
		areaEditorPane.setText("<h1><b>Text En Negreta y etiqueta H1</b></h1>" +
						" Text normal" + 
						"<font color=\"blue\"> Text amb color blau</font>"+
						"<font face=\"verdana\"> font de tipus Verdana</font>");
		...
		try {
			areaTextPane.getStyledDocument().insertString(
					areaTextPane.getStyledDocument().getLength(), "Text amb format roig, selecciona un check  ", estiloRojo);
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getSource()==boton) {
			if (check1.isSelected()) {
				retorno+="check1 seleccionat\n";
			}
			if (check2.isSelected()) {
				retorno+="check2 seleccionat\n";
			}
