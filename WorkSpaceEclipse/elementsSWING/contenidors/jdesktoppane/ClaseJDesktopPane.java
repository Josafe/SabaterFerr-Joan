...
public class ClaseJDesktopPane extends JDialog  implements ActionListener {
	...
	public ClaseJDesktopPane(VentanaPrincipal miVentanaPrincipal, boolean modal)
	{
	    ...
	    menuItemVentana1.setText("Mostra Finestra 1");
	...
	private void componentesPanel1() {
		...
		labelTitulo.setText("CONTENIDOR JDESKTOPPANE");
		labelTitulo.setBounds(90, 20, 180, 23);
		
		texto="Este contenidor presenta una Finestra Principal junt \naltres finestres internes." +
				"\nCada finestra ÉS independent i permet canviar la seua \nposició i el seu tamany." +
				"\n(si així ho hem configurat les seues propietats)";
