...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	public VentanaPrincipal(){
		...
		informacionAplicacion="Hola";
		
		informacionCoDejaVu="Hola";
		/**/
		/*permite iniciar las propiedades de los componentes*/
		iniciarComponentes();
   		/*Asigna un titulo a la barra de titulo*/
		setTitle("IES Benigasló - JFrame Finestra Principal");
	...
	private void iniciarComponentes() {
		...
		labelTitulo.setText("CONTENIDORS JAVA SWING");
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getSource()==menuItemAplicacion) {
			JOptionPane.showMessageDialog(null, informacionAplicacion,"INFORMACIÓ",JOptionPane.INFORMATION_MESSAGE);
		}
