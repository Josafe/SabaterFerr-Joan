...
public class FinestraPrincipal extends JFrame implements ActionListener,ChangeListener {
	...
	public FinestraPrincipal(){
		...
		setTitle("IES Benigasló : JFrame Components Atòmics");
	...
	private void iniciarComponentes() {
		...
		combo = new JComboBox();
		combo.addItem("Opcions");
		combo.addItem("Opció1");
		combo.addItem("Opció2");
		combo.addItem("Opció3");
		combo.addItem("Opció4");
