...
public class FinestraPrincipal extends JFrame implements ActionListener
	{
		...
		public FinestraPrincipal()//constructor
		{
			iniciarComponentes();
       		//Asigna un titulo a la barra de titulo
			setTitle("IES Benigasló - Components de Menú");
		...
		private void iniciarComponentes() {
	        ...
	        labelArchivo.setText("Fitxer : ");
	        
	        labelEdicion.setBounds(10,40,80,30);
	        labelEdicion.setText("Edita : ");
	        
	        labelOpciones.setBounds(10,60,80,30);
	        labelOpciones.setText("Opcions : ");
	        ...
	        menuItemNuevo.setText("Nou");
	        menuArchivo.add(menuItemNuevo);
	        menuArchivo.addSeparator();
	        
	        menuItemAbrir.setText("Obrir");
	        menuArchivo.add(menuItemAbrir);
	        menuArchivo.addSeparator();
	                       
	        menuItemGuardar.setText("Guarda");
	        menuArchivo.add(menuItemGuardar);
	        menuArchivo.addSeparator();
	        
	        itemSalir.setText("Ix");
	        menuArchivo.add(itemSalir);
	        
	        /*Crea los items del menu Edicion*/
	        menuItemCopiar.setText("Copia");
	        menuEdicion.add(menuItemCopiar);
	        	        
	        menuItemPegar.setText("Pega");
	        ...
	        menuItemGirar2.setText("Horitzontal");
		...
		public void actionPerformed(ActionEvent evento) {
			...
			if (evento.getSource()==itemEmergente1) {
				JOptionPane.showMessageDialog(null, "Has seleccionat l'opción emergent 1");
			}
			
			if (evento.getSource()==itemEmergente2) {
				JOptionPane.showMessageDialog(null, "Has seleccionat l'opción emergent 2");
			}
